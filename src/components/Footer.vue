  ...
  <footer class="bg-gray-900 text-gray-300 mt-16">
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <!-- About -->
        <div>
          <h3 class="text-white text-lg font-bold mb-4">About LuxeShop</h3>
          <p class="text-sm leading-relaxed">
            Your premium destination for quality products. We bring you the best selection of electronics and fashion items.
          </p>
